...
-- с вторыми колодами ровно на оборот. это позволяет сначала первую половину
...
{-
    ...
    Сначала приведу несколько примеров зацикливающихся колод карт:
-}
...
-- Я не дождался завершения этих функций.
